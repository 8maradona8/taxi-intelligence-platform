...
class SchedulerObservabilityOverviewResponse:
    ...
    def from_overview(
        ...
        *,
        scheduler_name: str = "airport-signal-scheduler",
        ...
        return cls(
            ...
            failures=SchedulerFailureBreakdownResponse.from_breakdown(
                overview.failure_breakdown
            ),
            trend=SchedulerReliabilityTrendResponse.from_trend(
                overview.reliability_trend
            ),
        )
